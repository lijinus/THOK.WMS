...
function StartRepeatAuthentication(obj2,TableName,FieldName,oldFiledContent)
{
//alert(obj.value);
obj=obj2;
...
createxmlhttp();
 ...
 var number = Math.random(); 
  url='../../../Common/IsRepeat.ashx?time='+number+'&TableName='+TableName+'&FieldName='+FieldName+'&FieldContent='+EncodeURI(FieldContent)+'&oldFiledContent='+EncodeURI(oldFiledContent);
