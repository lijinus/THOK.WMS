...
<style type="text/css">
  .even		{ background:white;}  /* 偶数行样式*/
  .odd		{ background:AliceBlue;}  /* 奇数行样式*/
  .over{background:#FFFFEE;}
  .selected		{ background:#99ffff;}
</style>
...
//    // 隔行换色 
//    alert();
//	$("#gvMain tr:odd").addClass('odd');
//	$("#gvMain tr:even:gt(0)").addClass('even');
//	
//	$("#gvMain tr:gt(0)").mouseover(function(){
//		$(this).addClass("over");
//	}).mouseout(function(){
...
//	});
//	
//	$('#gvMain tr:lt(1) input').click(function(){
// 		 var hasChecked=$(this).attr("checked");
// 		 if(hasChecked)
// 		 {
//		    $('#gvMain tr:gt(0):has(:checked)').addClass('selected');
//		 }
//		 else
//		 {
//        	 $('#gvMain tr:gt(0)').removeClass('selected');
//         }
                  ...
                  <tr>
                     ...
                     <td>
                       <table cellpadding="0" cellspacing="0">
                         <tr>
                           <td><asp:TextBox ID="txtEmployeeName" runat="server"  onfocus="CannotEdit(this)" CssClass="DisabledTextBox" Enabled="False" Width="164px"></asp:TextBox></td>
                           <td><input type="button" class="ButtonClear2" onclick="ClearName()"/></td>
                           <td><input type=button class="ButtonBrowse2" onclick="SelectDialog2('txtEmployeeCode,txtEmployeeName','BI_EMPLOYEE','EMPLOYEECODE,EMPLOYEENAME');"/></td>
                           <td><asp:TextBox ID="txtEmployeeCode" runat="server"  CssClass="HiddenControl"></asp:TextBox></td>
                         </tr>
                       </table>
                     </td>
                  </tr>
