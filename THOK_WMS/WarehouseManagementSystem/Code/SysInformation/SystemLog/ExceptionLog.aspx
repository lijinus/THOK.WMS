<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ExceptionLog.aspx.cs" Inherits="Code_SysInformation_SystemLog_ExceptionLog" %>
          ...
          <asp:Panel ID="pnlList" runat="server" Height="480px" Width="100%">
             ...
             <!--数据-->
              <asp:Panel ID="pnlMain" runat="server" Height="480px" Style="position: relative; overflow-x:hidden; overflow-y:auto;" Width="100%">
                  <asp:GridView ID="gvMain" runat="server" Style="position: relative;width:100%;"
                     OnRowDataBound="gvMain_RowDataBound" CssClass="GridStyle" CellPadding="3" CellSpacing="1" BorderWidth="0px" AutoGenerateColumns="False">
                      ...
                      <Columns>
                          ...
                          <asp:BoundField DataField="ExceptionalDescription" HeaderText="异常描述" >
                          </asp:BoundField>
                      </Columns>
                  </asp:GridView>
              </asp:Panel>
