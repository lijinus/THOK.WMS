<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserGroup.aspx.cs" Inherits="Code_SysInformation_UserGroupManage_UserGroup" %>
    ...
    <form id="form1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" Visible="true">
          ...
          <asp:Panel ID="pnlEdit" runat="server" Height="480px" Width="100%" Visible="false">
               ...
               <table>
                  <tr>
                     <td class="tdTitle"><font color="red">*</font>用户组名称</td>
                     <td><asp:TextBox ID="txtGroupName" runat="server" CssClass="TextBox" MaxLength="20"></asp:TextBox>
