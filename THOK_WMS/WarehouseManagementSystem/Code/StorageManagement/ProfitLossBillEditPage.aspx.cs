...
public partial class Code_StorageManagement_ProfitLossBillEditPage : BasePage
{
    ...
    protected void LoadBill(string BillNo)
    {
        ...
        if (dsMaster.Tables[0].Rows.Count == 1)
        {
            ...
            this.txtCHECKBILLNO.Text = dsMaster.Tables[0].Rows[0]["CHECKBILLNO"].ToString();
        }
        LoadDetail();
    }
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (this.hdnOpFlag.Value == "0")
            {
                ...
                JScript.Instance.ShowMessage(this, "损益单汇总信息保存成功");
            }
            else
            {
                billMaster.BILLNO = this.txtBillNo.Text;
                billMaster.CHECKBILLNO = this.txtCHECKBILLNO.Text;
                billMaster.BILLDATE = Convert.ToDateTime(this.txtBillDate.Text);
                billMaster.BILLTYPE = this.txtBillTypeCode.Text;
                ...
                billMaster.MEMO = this.txtMemo.Text.Trim().Replace("\'", "\''");
                billMaster.Update();
                JScript.Instance.ShowMessage(this, "损益单汇总信息修改成功");
            }
        }
        catch (Exception exp)
        {
        ...
        try
        {
            ...
            else if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                btn1.OnClientClick = string.Format("SelectCell('{0},{1},{2},{3},{4},{5},{6}')"
                                                  ...
                                                  , tb1.ClientID.Replace("cellcode", "") + "profitquantity");
                ...
                tb7.ID = "profitquantity";
                tb7.Text = e.Item.Cells[8].Text;
                tb7.Attributes.Add("style", "width:50px;");
                tb7.Attributes.Add("class", "GridInputAlignRight");
    ...
    protected void btnSaveDetail_Click(object sender, EventArgs e)
    {
        for (int i = 0; i < dgDetail.Items.Count; i++)
        {
            ...
            billDetail.QUANTITY = Convert.ToDecimal(((TextBox)(dgDetail.Items[i].Cells[8].Controls[0])).Text);
            billDetail.Update();
        }
        LoadDetail();
    }
    ...
    {
        Response.Redirect("ProfitLossBillPage.aspx?back=true");
    }
    #endregion
