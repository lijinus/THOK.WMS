<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitLossBillEditPage.aspx.cs" Inherits="Code_StorageManagement_ProfitLossBillEditPage" %>
    ...
    <form id="form1" runat="server">
       ...
       <table style="width:100%; " cellpadding="0" cellspacing="1" >
                      ...
                      <td >
                            <table  cellpadding="0" cellspacing="0">
                              <tr><td><asp:TextBox ID="txtBillTypeName" runat="server" CssClass="myinput" TabIndex="1" ></asp:TextBox></td>
                                  ...
                                  <td><input id="Button2" class="ButtonBrowse2" type="button" value="" onclick="SelectDialog2('txtBillTypeCode,txtBillTypeName','WMS_BILLTYPE','TYPECODE,TYPENAME','BUSINESS','5');" /></td>
                              </tr>
                            </table>
                       </td>                      
                    </tr>
                    ...
                    <tr>
                      ...
                      <td class="tdTitle">
                          来源盘点单</td>
                      <td><asp:TextBox ID="txtCHECKBILLNO" runat="server" CssClass="myinput" Enabled="False"></asp:TextBox></td>
                    </tr>
                    <tr style="height:6px;"><td colspan="6">&nbsp;</td></tr>                    
                  </table>
       ...
       <div class="edit_detail_header">
         <table cellpadding="0"  cellspacing="0" width="100%">
            <tr>
               ...
               <td style=" text-align:right;">提示：损益数量，正表示报益，加库存；负表示报损，减库存。</td>
            </tr>
         </table>
       </div>   
