<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitLossBillValidationPage.aspx.cs" Inherits="Code_StorageManagement_ProfitLossBillValidationPage" %>
                ...
                <table  class="OperationBar2" cellpadding="2" cellspacing="0" >
                   <tr>
                     <td style=" width:470px;">
                       <table >
                           ...
                           <tr>
                             ...
                             <td class="tdTitle">损益类别</td>
                             <td>
                                 <asp:DropDownList ID="ddlBillType" runat="server">
                                     <asp:ListItem Selected="True" Value="1">所有损益单</asp:ListItem>
                                 </asp:DropDownList></td>
                           </tr>    
                       </table>
                     </td>
                     ...
                     <td style="text-align:right;">
                         <asp:Button ID="btnValidate" runat="server" Text="审核" CssClass="ButtonAudit" OnClientClick="return ValidateConfirm();" OnClick="btnValidate_Click"/>&nbsp;
                     </td>
...
function ValidateConfirm()
{
     ...
     if(!hasChecked)
     {
      ...
      if(confirm('损益单审核后将会更新货位库存量，但无法反向审核。\n继续请按确定','审核提示'))
      {
         return true;
      }
      else
