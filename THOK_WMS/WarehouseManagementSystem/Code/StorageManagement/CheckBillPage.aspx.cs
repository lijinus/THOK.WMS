...
public partial class Code_StorageManagement_CheckBillPage : BasePage
{
    int pageIndex = 1;
    int pageSize = 5;
    int totalCount = 0;
    ...
    protected void gvMain_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        ...
        else if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            lnkBtn.Text = "编辑";
            lnkBtn.OnClientClick = string.Format("javascript:window.open('CheckBillEditPage.aspx?BILLNO={0}&time={1}','_self');return false;", e.Row.Cells[2].Text, System.DateTime.Now);
            ...
            for (int i = 0; i < gvMain.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (chk.Enabled && chk.Checked)
                    {
                        ...
                        {
                            JScript.Instance.ShowMessage(this.UpdatePanel1, "已审核的盘点单不能删除");
                            return;
                        }
