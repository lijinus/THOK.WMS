<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckBillConfirmPage.aspx.cs" Inherits="Code_StorageManagement_CheckBillConfirmPage" %>
                ...
                <table  class="OperationBar2" cellpadding="2" cellspacing="0" >
                   <tr>
                     <td style=" width:470px;">
                       <table >
                           ...
                           <tr>
                             ...
                             <td class="tdTitle">盘点类别</td>
                             <td>
                                 <asp:DropDownList ID="ddlBillType" runat="server">
                                     <asp:ListItem Selected="True" Value="1">所有盘点单</asp:ListItem>
                                 </asp:DropDownList></td>
                           </tr>    
                       </table>
                     </td>
                     <td><asp:Button ID="btnQuery" runat="server" Text="查询"  CssClass="ButtonQuery" OnClick="btnQuery_Click"/>
                         ...
                         <asp:Button ID="btnValidate" runat="server" Text="确认损益" CssClass="ButtonAudit" OnClick="btnValidate_Click"/>
                     </td>
                     <td style="text-align:right;">
                         
                         <asp:Button ID="btnReverseValidate" runat="server" Text="取消" CssClass="ButtonAudit2" OnClick="btnReverseValidate_Click" Visible="False"/>
                     </td>
