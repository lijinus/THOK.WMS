<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoveBillValidationPage.aspx.cs" Inherits="Code_StorageManagement_MoveBillValidationPage" %>
                     ...
                     <td style=" width:470px;">
                       <table >
                           ...
                           <tr>
                             ...
                             <td class="tdTitle">移位类别</td>
                             <td>
                                 <asp:DropDownList ID="ddlBillType" runat="server">
                                     <asp:ListItem Selected="True" Value="1">所有移位单</asp:ListItem>
                                 </asp:DropDownList></td>
                           </tr>    
                       </table>
                     </td>
