<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckBillByCell.aspx.cs" Inherits="Code_StorageManagement_CheckBillByCell" %>
  ...
  <tr>
    <td align="center">
        ...
        <table width="98%" style="display:<%=div01display%>" cellpadding="0" cellspacing="0">
           <tr><td style=" line-height:16pt; height: 30px;"  class="edit_detail_header">
               &nbsp; &nbsp; 请将要盘点的货位打<span style="color:red"><strong>√ </strong></span></td>
               </tr>
           <tr>
             <td style="padding: 1 1 1 1; " class="edit_detail_body">
                <table style="width:100%; background-color:AliceBlue;" cellpadding="0" cellspacing="0">
                   <tr>
                      <td class="SideBar"><!--仓库架构-->             
                           
                            <div style="overflow-x:hidden; overflow-y:scroll; width:250px; height:440px;">
                              <yyc:smarttreeview ID="tvWarehouse" runat="server" ShowLines="True" ExpandDepth="3" OnSelectedNodeChanged="tvWarehouse_SelectedNodeChanged" AllowCascadeCheckbox="true"  ShowCheckBoxes="All">
                      ...
                      <td style="vertical-align:top; padding-left:1px;"> 
                        ...
                        <div style="height:30px;vertical-align:middle; width:100% ; padding-top:5px;">
                           <img src="../../images/ico_home.gif" border="0" />当前选中的节点：
                           <asp:Label ID="lblCurrentNode" runat="server" ForeColor="#404040"></asp:Label></div>
