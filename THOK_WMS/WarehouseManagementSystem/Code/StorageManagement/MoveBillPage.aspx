<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoveBillPage.aspx.cs" Inherits="Code_StorageManagement_MoveBillPage" %>
               ...
               <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="GridStyle" CellSpacing="1" GridLines="None" Width="100%" OnRowDataBound="gvMain_RowDataBound">
                   <Columns>
                       <asp:TemplateField>
                           ...
                           <ItemStyle HorizontalAlign="Center" VerticalAlign="Middle" BackColor="#F8F8F8" />
                       </asp:TemplateField>
                       <asp:TemplateField>
