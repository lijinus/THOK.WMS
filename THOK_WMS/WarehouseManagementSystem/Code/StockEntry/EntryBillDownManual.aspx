<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EntryBillDownManual.aspx.cs" Inherits="Code_StockEntry_EntryBillDownManual" %>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                <table style="width:100%;font-size:12px;" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td>
                            <div style="height:300px;" class="edit_body">
                ...
                <div style="height:240px;" class="edit_detail_body">
                    ...
                    <asp:Label ID="lblMsg" runat="server" Text="<br><br><br>无记录" style="width:99%; text-align:center;" Visible="False" Height="100px"></asp:Label>
                </div>
