...
public partial class Code_StockEntry_EntryAllot :BasePage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Application["MNU_M00B_00D"] == null || Application["MNU_M00B_00D"].ToString() == userName || Application["MNU_M00B_00D"].ToString() == "")
        {
            if (!IsPostBack)
            {
            ...
            Application["MNU_M00B_00D"] = Session["G_user"];
        }
        else
        {
            Exception exp = new Exception();
            Session["ModuleName"] = "入库分配";
            Session["FunctionName"] = "Page_Load";
            Session["ExceptionalType"] = exp.GetType().FullName;
            Session["ExceptionalDescription"] = "该页面已为" + Application["MNU_M00B_00D"].ToString() + "用户占用，请稍候...";
    ...
    protected void btnNext_Click(object sender, EventArgs e)
    {
        ...
        {
            JScript.Instance.ShowMessage(this.UpdatePanel1, "请选择入库单");
            return;
        }
    ...
    {
        Response.Redirect("EntryAutoAllotPage.aspx?time="+System.DateTime.Now.ToLongTimeString());
    }
