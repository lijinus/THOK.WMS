<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryBillPage.aspx.cs" Inherits="Code_StockDelivery_DeliveryBillPage" %>
...
<body>
    <form id="form1" runat="server">
                  ...
                  <table style="width:100%; height:20px;">
                     <tr>
                       <td style="height: 22px">
                           ...
                           <%--<asp:TextBox ID="txtKeyDate" runat="server" CssClass="TextBox" Width="100px"></asp:TextBox>
                           <input id="Button2" type="button" value="" onclick="setday(txtKeyDate)" class="ButtonDate" />--%>
                           <asp:Button ID="btnUniteBill" runat="server" Text="合单" CssClass="ButtonDown" OnClick="btnUniteBill_Click" />
                        </td>
                        <td style="height:22px" align="right">
                           ...
                           <asp:Button ID="btnUnite" runat="server" Text="分拣线" CssClass="ButtonDown" OnClick="btnUnite_Click" /> 
                           --%>
                        </td>
                     </tr>
                  </table>
      ...
      <div style=" height:440px;" class="edit_detail_body">
      ...
      <div Style=" text-align:right;" class="edit_detail_pager"><!--明细分页-->
              <NetPager:AspNetPager ID="pager2" Width="450" runat="server" OnPageChanging="pager2_PageChanging" ShowPageIndex="false" ShowInputBox="Always" AlwaysShow="true" SubmitButtonStyle="margin-top:0px;border:solid 0px gray; background-color:transparent; cursor:hand;"></NetPager:AspNetPager>
      </div>--%>
