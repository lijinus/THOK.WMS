<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryBillEditPage.aspx.cs" Inherits="Code_StockDelivery_DeliveryBillEditPage" %>
...
<body>
    <form id="form1" runat="server">
          <table class="OperationBar" style="width:100%;">
             <tr>
               ...
               <td style=" white-space:nowrap; text-align:right;">
                 ...
                 <asp:Button ID="btnBack" runat="server" Text=" 返回" CssClass="ButtonBack" Visible="true"  OnClientClick="return Back();" />
               </td>
             </tr>
          </table>
       ...
       <table style="width:100%; " cellpadding="0" cellspacing="1" >
                      ...
                      <td >
                            <table  cellpadding="0" cellspacing="0">
                              <tr><td><asp:TextBox ID="txtBillTypeName" runat="server" CssClass="myinput" TabIndex="1" ></asp:TextBox></td>
                                  ...
                                  <td><input id="Button2" class="ButtonBrowse2" type="button" value="" onclick="SelectDialog2('txtBillTypeCode,txtBillTypeName','WMS_BILLTYPE','TYPECODE,TYPENAME','BUSINESS','2');" /></td>
                              </tr>
                            </table>
                       </td>                      
                    </tr>
                    ...
                    <tr>
                      ...
                      <td><asp:TextBox ID="txtValidatePerson" runat="server" CssClass="myinput" Enabled="False" ></asp:TextBox></td>
                        ...
                        <td class="tdTitle">出库仓库</td>
                        <td>
                           <table cellpadding="0" cellspacing="0">
                              <tr>
                                <td style="height: 24px"><asp:TextBox ID="txtWHNAME" runat="server" CssClass="myinput" TabIndex="2"></asp:TextBox></td>
                                <td style="height: 24px; width: 19px;"><input id="Button1" class="ButtonBrowse2" type="button" value="" onclick="SelectDialog2('txtWHCODE,txtWHNAME,lblUnitCode,lblUnitName','WMS_WAREHOUSE','WH_CODE,WH_NAME,DEFAULTUNIT,UNITNAME');" /></td>
                                <td style="height: 24px"><asp:TextBox ID="txtWHCODE" runat="server" CssClass="HiddenControl"></asp:TextBox></td>
                                <td style="height: 24px; width: 7px;"><asp:TextBox ID="lblUnitCode" runat="server" Text="" CssClass="HiddenControl"></asp:TextBox>
       ...
       <div style="" class=edit_detail_body>
       ...
       <div Style=" text-align:right;" class="edit_detail_pager"><!--分页导航-->
