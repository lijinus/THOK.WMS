...
public partial class Code_StockDelivery_DeliveryValidationPage :BasePage
{
    int pageIndex = 1;
    int pageSize = 5;
    int totalCount = 0;
    ...
    void DetailDataBind()
    {
        ...
        this.lblTotalAmount.Text = dsMaster.Tables[0].Rows[i]["TOTALOUTPUTAMOUNT"].ToString();
        this.lblTotalQty.Text = dsMaster.Tables[0].Rows[i]["TOTALOUTPUTQUANTITY"].ToString();
    }
    #endregion
                ...
                else
                {
                    ...
                    if (chk.Enabled && chk.Checked)
                    {
                        ...
                        else
                        {
                            ...
                            updateBll.outBillAudot(Session["EmployeeCode"].ToString(), dsMaster.Tables[0].Rows[i]["BILLNO"].ToString());
                        }
                    }
                }
            }
            ...
            for (int i = 0; i < gvMain.Rows.Count; i++)
            {
                ...
                else
                {
                    ...
                    if (chk.Enabled && chk.Checked)
                    {
                        ...
                        updateBll.outReBbillAudot(dsMaster.Tables[0].Rows[i]["BILLNO"].ToString());
                    }
                }
            }
