<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryAllotmentConfirmPage.aspx.cs" Inherits="Code_StockDelivery_DeliveryAllotmentConfirmPage" %>
                       ...
                       <table >
                           ...
                           <tr>
                             <td class="tdTitle">
                                 备注信息</td>
                             <td>
                                 <asp:TextBox ID="txtMemo" runat="server" Width="211px"></asp:TextBox></td>
                             
                             <td class="tdTitle">出库类别</td>
                             <td>
                                 <asp:DropDownList ID="ddlBillType" runat="server">
                                     <asp:ListItem Selected="True" Value="2">所有出库单</asp:ListItem>
                                 </asp:DropDownList></td>
                           </tr>    
                       </table>
                     </td>
           ...
           <div style=" height:210px; " class="edit_body">
               <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="GridStyle" CellSpacing="1" GridLines="None" Width="100%" OnRowDataBound="gvMain_RowDataBound">
                   <Columns>
                       ...
                       <asp:BoundField DataField="QTY_JIAN" HeaderText="总数量" DataFormatString="{0:N2}">
          ...
          <!--分页导航-->
           <div Style=" text-align:left;" class="edit_pager">
            ...
            <div class="edit_detail_header">
               <table cellpadding="0"  cellspacing="0">
                    <tr>
                       <td style="padding-left:1em; padding-top:5px; height:30px;">出库单<asp:Label ID="lblBillNo" runat="server" ForeColor="Red"></asp:Label>分配结果</td>
                       <td></td>
                       <td style="">&nbsp;</td>
                    </tr>
               </table>
...
<asp:Panel ID="pnlAllotment" runat="server" style="display:block;"  Width="100%"> 
              ...
              <div Style=" text-align:right;" class="edit_detail_pager"><!--分配结果分页-->
                 <NetPager:AspNetPager ID="pager3" runat="server" OnPageChanging="pager3_PageChanging" ShowPageIndex="false" ShowInputBox="Always" AlwaysShow="true" SubmitButtonStyle="margin-top:0px;border:solid 0px gray; background-color:transparent; cursor:hand;" Width="450px"></NetPager:AspNetPager>
             </div>
</asp:Panel>   
