<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DeliveryAllotPage.aspx.cs" Inherits="Code_StockDelivery_DeliveryAllotPage" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../JScript/Check.js?time=201001" type="text/javascript"></script>
    <style>
     .content_panel
     {
        width:100%;
        ...
        <asp:Panel ID="pnlOne" runat="server"  CssClass="content_panel"  Width="100%" >
                 ...
                 <asp:DataGrid ID="dgMaster" runat="server" AutoGenerateColumns="False" CssClass="GridStyle"
                     ...
                     <Columns>
                         ...
                         <asp:BoundColumn DataField="TOTALQUANTITY" HeaderText="总数量">
                             <ItemStyle Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False"
                                 Font-Underline="False" HorizontalAlign="Right" />
                             <HeaderStyle Width="60px" />
                         </asp:BoundColumn>
                         <asp:BoundColumn DataField="BILLTYPE" HeaderText="出库类别">
                             <HeaderStyle Width="80px" />
                         </asp:BoundColumn>
                 ...
                 <asp:Label ID="lblMsg" runat="server" Text="<br><br><br>没有要分配的出库单" style="width:100%; text-align:center;" Visible="False" Height="100px" BorderColor="Gainsboro" BorderStyle="Solid" BorderWidth="1px"></asp:Label>
        </asp:Panel>
