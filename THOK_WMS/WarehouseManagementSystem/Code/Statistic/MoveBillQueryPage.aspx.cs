...
public partial class Code_Statistic_MoveBillQueryPage :BasePage
{
    int pageIndex = 1;
    int pageSize = 5;
    int totalCount = 0;
    ...
    protected void btnMoveBillExcel_Click(object sender, EventArgs e)
    {
        try
        {
            filter = "*";
            string tableName = "V_WMS_MOVE_BILLDETAIL";
    ...
    protected string Export(DataTable dt)
    {
        ...
        string fileName = this.lblBillNo.Text.ToString() + "移库单";
        xls.FileName = fileName;
        int rowIndex = 1;
        Worksheet sheet = xls.Workbook.Worksheets.Add("移库单");
        Cells cells = sheet.Cells;
        sheet.Cells.Merge(1, 1, 1, 10);
        Cell cell = cells.Add(1, 1, "移库单");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 1, "单据号");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 2, "移出货位编码");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 3, "移出货位名称");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 4, "移入货位编码");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 5, "移入货位名称");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 6, "产品代码");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 7, "产品名称");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        ...
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        cell = cells.Add(2, 10, "数量");
        cell.Font.Bold = true;
        cell.HorizontalAlignment = HorizontalAlignments.Centered;
        foreach (DataRow row in dt.Rows)
        {
            cells.Add(rowIndex + 2, 1, "" + row["BILLNO"] + "");
            cells.Add(rowIndex + 2, 2, "" + row["OUT_CELLCODE"] + "");
            cells.Add(rowIndex + 2, 3, "" + row["OUT_CELLNAME"] + "");
            cells.Add(rowIndex + 2, 4, "" + row["IN_CELLCODE"] + "");
            cells.Add(rowIndex + 2, 5, "" + row["IN_CELLNAME"] + "");
            cells.Add(rowIndex + 2, 6, "" + row["PRODUCTCODE"] + "");
            cells.Add(rowIndex + 2, 7, "" + row["PRODUCTNAME"] + "");
            cells.Add(rowIndex + 2, 8, "" + row["UNITCODE"] + "");
            cells.Add(rowIndex + 2, 9, "" + row["UNITNAME"] + "");
            cells.Add(rowIndex + 2, 10, "" + row["QUANTITY"] + "");
            rowIndex++;
        }
