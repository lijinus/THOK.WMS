<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MoveBillQueryPage.aspx.cs" Inherits="Code_Statistic_MoveBillQueryPage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <Triggers>
        <asp:PostBackTrigger ControlID="btnMoveBillExcel" />
        </Triggers>
           <ContentTemplate>    
                     ...
                     <tr>
                       <td style="height: 22px">
                           <asp:DropDownList ID="ddl_Field" runat="server">
                               <asp:ListItem Selected="True" Value="BILLNO">移位单号</asp:ListItem>
                        ...
                        <td align="right">
                           <asp:Button ID="btnMoveBillExcel" runat="server" Text="导出Excel" CssClass="ButtonDown" OnClick="btnMoveBillExcel_Click" />
                        </td>
                     </tr>
                  </table>
             </asp:Panel>
           ...
           <div style="height:210px; " class="edit_body">
               <asp:GridView ID="gvMain" runat="server" AutoGenerateColumns="False" CssClass="GridStyle" CellSpacing="1" GridLines="None" Width="100%" OnRowDataBound="gvMain_RowDataBound">
                   <Columns>
                       ...
                       <asp:BoundField DataField="BillNo" HeaderText="移位单号" >
                 ...
                 <table cellpadding="0"  cellspacing="0">
                    <tr>
                       <td colspan="3" style="padding-left:1em; padding-top:5px; height:30px;">
                           移位单<asp:Label ID="lblBillNo" runat="server" ForeColor="Red"></asp:Label>明细</td>
                    </tr>
                </table>
          </div>
...
function ShowQueryDialog()
{
    ...
    var TableName='WMS_MOVE_BILLMASTER';
