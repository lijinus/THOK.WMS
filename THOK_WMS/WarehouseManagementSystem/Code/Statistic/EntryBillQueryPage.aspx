<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EntryBillQueryPage.aspx.cs" Inherits="Code_Statistic_EntryBillQueryPage" %>
...
<body>
    <form id="form1" runat="server">
      ...
      <table style="width:100%;font-size:12px; " cellpadding="0" cellspacing="0">
                  ...
                  <table style="width:100%; height:20px;">
                     <tr>
                       <td style="height: 22px">
                           ...
                           <%--<asp:TextBox ID="txtProductCode" runat="server" CssClass="myinput" Width="140px"></asp:TextBox>
                           <input id="Button2" class="ButtonBrowse2" onclick="SelectDialog2('txtProductCode','WMS_PRODUCT','PRODUCTCODE',txtProductCode.value);" type="button" value="" />
                           <asp:Button ID="btnQuery3" runat="server" Text="查询" OnClick="btnQuery3_Click" CssClass="ButtonQuery"/>--%>
                        </td>
                        <td>
                           <asp:Button ID="btnInBillExcel" runat="server" Text="导出Excel" CssClass="ButtonDown" OnClick="btnInBillExcel_Click" />
                        </td>
                     </tr>
                  </table>
             </asp:Panel>
       ...
       <div id="divAllotment" style="display:none;"><!--分配明细-->   
           <div class="edit_detail_header">
             <table cellpadding="0"  cellspacing="0" width="100%">
                <tr>
                   <td style="padding-left:1em; padding-top:5px; height:30px;">入库分配明细</td>
                   <td align="right"><asp:Button ID="btnAllotExcel" runat="server" Text="明细分配导出" CssClass="ButtonDown" OnClick="btnAllotExcel_Click" /></td>
                   <td style="width:100px;"><span style="cursor:pointer; text-align:center;" onclick="javascript:divAllotment.style.display='none';divDetail.style.display='block';">&nbsp;&nbsp;返回入库明细</span></td>
                </tr>
             </table>
          </div> 
            <div  class="edit_detail_body">
...
function ShowQueryDialog()
{
    ...
    var TableName='WMS_IN_BILLMASTER';
