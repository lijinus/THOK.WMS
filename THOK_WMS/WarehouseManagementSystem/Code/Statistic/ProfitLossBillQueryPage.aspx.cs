...
public partial class Code_Statistic_ProfitLossBillQueryPage :BasePage
{
    int pageIndex = 1;
    int pageSize = 5;
    int totalCount = 0;
    ...
    protected void btnProfitLossBill_Click(object sender,EventArgs e)
    {
        try
        {
            filter = "*";
            string tableName = "V_WMS_PL_BILLDETAIL";
    ...
    protected string Export(DataTable dt)
    {
        ...
        string fileName = this.lblBillNo.Text.ToString() + "损溢单";
        xls.FileName = fileName;
        int rowIndex = 1;
        Worksheet sheet = xls.Workbook.Worksheets.Add("损溢单");
        Cells cells = sheet.Cells;
        sheet.Cells.Merge(1, 1, 1, 8);
        Cell cell = cells.Add(1, 1, "" + this.lblBillNo.Text + "" + "损溢单");
        cell.Font.Bold = true;
