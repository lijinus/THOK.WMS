<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProfitLossBillQueryPage.aspx.cs" Inherits="Code_Statistic_ProfitLossBillQueryPage" %>
                  ...
                  <table style="width:100%; height:20px;">
                     <tr>
                       <td style="height: 22px">
                        ...
                        <td align="right">
                           <asp:Button ID="btnProfitLossBill" runat="server" Text="明细导出" CssClass="ButtonDown" OnClick="btnProfitLossBill_Click" />
                        </td>
                     </tr>
                  </table>
             </asp:Panel>
...
function ShowQueryDialog()
{
    ...
    var TableName='WMS_PL_BILLMASTER';
